...
export const defaultRiskDashboardConfig: DashboardConfig = {
    ...
    widgets: [
        ...
        { id: 'responsible-ai-index', type: 'responsible-ai-index', title: 'Responsible AI Index', description: 'Enterprise-wide AI health and risk score.', layout: { colSpan: 2, rowSpan: 2 }, dataSource: { type: 'rest', endpoint: '/api/widgets/responsible-ai-index/data', staleTime: 60000 } },
        ...
        { id: 'monthly-cost', type: 'monthly-cost', title: 'Monthly AI Cost', description: 'Total enterprise AI infrastructure and model operational cost.', layout: { colSpan: 2, rowSpan: 2 }, dataSource: { type: 'rest', endpoint: '/api/widgets/monthly-cost/data', staleTime: 30000 } },
